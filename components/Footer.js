...
const Footer = () => {
  return (
    ...
    <div className="footer-widget-section">
        ...
        <img className="shape-1 animation-down" src="images/shape/shape-21.png" alt="Shape" />
        ...
        <img className="shape-2 animation-left" src="images/shape/shape-22.png" alt="Shape" />
        ...
        <div className="container">
            ...
            <div className="copyright-wrapper">
                ...
                <div className="copyright-text">
                    <p>&copy; 2021 <span> Edule </span> Made with <i className="icofont-heart-alt"></i> by <a href="#">Codecarnival</a></p>
                </div>
            </div>
